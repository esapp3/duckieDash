...
PRODUCT_NAME       = cs2261
SOURCES            = main.c myLib.c whiteTiles.c biteSoundFX.c sound4.c duckieSong.c background1.c collisionwater.c collisionfull.c Sprites.c bath.c gameHelp.c Controls.c HowPlay.c HowPlay2.c
