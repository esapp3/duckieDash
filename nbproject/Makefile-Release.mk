...
${OBJECTDIR}/Controls.o: Controls.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Controls.o Controls.c

${OBJECTDIR}/HowPlay.o: HowPlay.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HowPlay.o HowPlay.c

${OBJECTDIR}/HowPlay2.o: HowPlay2.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HowPlay2.o HowPlay2.c
...
${OBJECTDIR}/background1.o: background1.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/background1.o background1.c

${OBJECTDIR}/bath.o: bath.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bath.o bath.c

${OBJECTDIR}/biteSoundFX.o: biteSoundFX.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/biteSoundFX.o biteSoundFX.c

${OBJECTDIR}/collisionfull.o: collisionfull.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/collisionfull.o collisionfull.c

${OBJECTDIR}/collisionwater.o: collisionwater.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/collisionwater.o collisionwater.c

${OBJECTDIR}/duckieSong.o: duckieSong.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/duckieSong.o duckieSong.c

${OBJECTDIR}/gameHelp.o: gameHelp.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gameHelp.o gameHelp.c
...
${OBJECTDIR}/sound4.o: sound4.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sound4.o sound4.c

${OBJECTDIR}/whiteTiles.o: whiteTiles.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/whiteTiles.o whiteTiles.c
